...
export default function CheckoutPage() {
  ...
  const itemsWithDays = cart.map((item) => {
    ...
    const deposit =
      (item.price || 0) * DEPOSIT_MULTIPLIER * (item.quantity || 1);
  ...
  const updateDays = (itemId, val) => {
    setRentalDays((prev) => ({
      ...prev,
      [itemId]: Math.max(1, Math.min(30, Number(val))),
    }));
  };
        ...
        <div>
          ...
          <div className="mt-4 bg-orange-950/40 border border-orange-800/40 rounded-xl p-4">
            ...
            <p className="text-orange-200/70 text-xs leading-relaxed">
              ...
              <strong className="text-orange-300">×{DEPOSIT_MULTIPLIER}</strong>{" "}
              the daily rental fee is charged per item. Refunded within 3–5
              business days after return.
            </p>
          </div>
        </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
            ...
            <div className="space-y-3 mb-5">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-[#C3FF51] font-semibold">
          ...
          <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl max-w-sm w-full text-center shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            {paymentMethod === "promptpay" ? (
              <div>
                ...
                <p className="text-xs text-zinc-400 mb-4">
                  Please capture and scan with your banking app
                </p>
                ...
                <div className="bg-white p-4 rounded-xl inline-block mb-4">
                  <div className="w-44 h-44 bg-zinc-100 flex flex-col items-center justify-center border border-zinc-300 relative rounded-lg">
                    <div className="absolute top-2 font-bold text-blue-900 text-[11px] tracking-wider uppercase">
                      Prompt Pay
                    </div>
                    <svg
                      className="w-24 h-24 text-zinc-900 mt-2"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <div className="absolute bottom-2 text-[11px] font-bold text-zinc-800">
                      ฿{grandTotal.toLocaleString()}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-left mb-5">
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg p-2.5 text-sm text-zinc-400 outline-none cursor-not-allowed"
                    />
                  </div>
            ...
            <div className="border-t border-zinc-800 pt-4 flex flex-col items-center justify-center gap-2">
              ...
              <p className="text-xs font-medium text-zinc-400">
                Verifying secure payment connection...
              </p>
